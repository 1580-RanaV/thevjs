...
const Adidas = () => {
  const workDetails = [
    ...
    },
    {
      ...
      description:
        'For the Adidas pop-up store at Dubai Airport Terminal A, I designed a compact, striking space with a perforated screen faAade that captures attention and creates a dynamic experience, drawing travelers into the store amidst the busy terminal.',
      images: [
    ...
    },
    {
      ...
      description:
        'At Cape Towns Canal Walk Mall, I developed one of the first Home of Sport (HOS) concepts in the country, focusing on an accessible, intriguing design with a seamless faAade integration. By optimizing layout and incorporating innovative elements, I created a unique, immersive space that enhances the overall shopping experience while showcasing the HOS brand.',
      images: [
    ...
    },
    {
      ...
      description:
        'For the Adidas MENA headquarters redesign, I revamped two floors by blending traditional and modern elements, integrating regional art, optimizing lighting, and utilizing unused spaces to create a functional, engaging, and locally reflective workspace.',
      images: [
        '/adidas/d3/pic (1).png',
        '/adidas/d3/pic (2).png',
        '/adidas/d3/pic (3).png',
    ...
    },
    {
      ...
      description:
        'The Pulse Factory Outlet, the largest store of its kind in the region, is located in Dubai Outlet Village. I creatively adapted the design to harmonize with the existing elevation, reimagining the faAade to enhance visual appeal while maintaining coherence with the surrounding environment, resulting in a striking and cohesive presence.',
      images: [
    ...
    },
    {
      ...
      description:
        'The Kids Store Concept, the first flagship store for children in the region, uses a vibrant material palette to reflect its playful audience. The design features a dynamic, parametric cash desk backwall, developed with architect Arturo Tedeschi, adding architectural depth and enhancing the customer experience.',
      images: [
    ...
    },
    {
      ...
      description:
        'The Home of Sport flagship store at Marina Bay Sands features a striking design with a curving faAade and a central column transformed into an art element. This design draws attention while optimizing space with a footwear trial area, enhancing the stores appeal and the overall shopping experience.',
      images: [
    ...
    },
    {
      ...
      place: 'Dubai mall, Dubai, UAE',
      description:
        'The Originals Concept store at Dubai Mall is one of the largest flagship stores globally and the first of its kind. I revamped the customer activation zones, designing engaging areas that reflect the brands identity and enhance the immersive shopping experience, aligning with the stores prestigious status and innovative offerings.',
      images: [
