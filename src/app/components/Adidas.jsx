...
const Adidas = () => {
  ...
  const workDetails = [
    {
      title: 'adidas halo, dezingof, israel',
    ...
    {
        title: 'adidias popup, terminal 1, dubai airport',
    ...
    images: [
        '/adidas/canalwalk/live.jpg',
        '/adidas/canalwalk/live2.jpg',
        '/adidas/canalwalk/pic (1).png',
        '/adidas/canalwalk/pic (2).png',
        '/adidas/canalwalk/pic (3).png',
        '/adidas/canalwalk/pic (4).png',
        '/adidas/canalwalk/pic (5).png',
    ],
    },

    {
        title: 'adidas head office, dubai design district',
    ...
    {
        title: 'adidas pulse fo, duabi outlet village',
    ...
    {
        title: 'adidas kids flagship store, dubai',
    ...
    {
        title: 'adidas makerlab, dubai mall',
    ...
    {
        title: 'adidas marina bay sands, singapore',
    ...
    {
        title: 'adidas originals, mall of the emirates, dubai',
    ...
    {
        title: 'adidas originals flagship, dubai mall',
